 ...
 */
namespace Lof\Setup\Block\Adminhtml\Import\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
         ...
         */
        if($this->_isAllowedAction('Lof_Setup::import')) {
...
*/
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Lof Setup Import')]);
