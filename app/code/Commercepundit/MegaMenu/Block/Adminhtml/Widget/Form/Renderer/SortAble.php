<?php
namespace Commercepundit\MegaMenu\Block\Adminhtml\Widget\Form\Renderer;
...
class SortAble extends Template implements RendererInterface
{
	...
	{
		parent::_construct();
		$this->setTemplate('Commercepundit_MegaMenu::menuitems/edit/form/renderer/sortable.phtml');
	}
