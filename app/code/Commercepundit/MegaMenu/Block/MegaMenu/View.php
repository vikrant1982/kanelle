...
class View extends Template
{
	...
	)
	{
		...
		$this->addData([
			...
			'cache_tags'     => ['cp_megamenu'],
			'cache_key'      => 'gropus100'.$this->_defaults['group_id'],
		]);
	}
	...
	protected function _toHtml()
	{
		...
		if ($use_cache){
			...
			if ($data = $Cache_Lite->get($hash)) {
				...
				$template_file = (!empty($template_file)) ? $template_file : "Commercepundit_MegaMenu::megamenu.phtml";
